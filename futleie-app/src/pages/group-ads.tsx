...
/**
 * GroupAds komponenten viser alle annonser (items) knyttet til en spesifikk gruppe.
 *
 * @returns {JSX.Element} En side som viser gruppedetaljer og tilhørende annonser i et grid,
 * med mulighet for å navigere tilbake eller legge til nye items til gruppen.
 *
 * @example
 * // Brukt i routing i App.tsx
 * <Route path="/gruppe/:groupId" element={<GroupAds />} />
 */
export default function GroupAds() {
    ...
    // Hent gruppe og annonser tilknyttet gruppen
    useEffect(() => {
        async function fetchGroupAndAds() {
            ...
            try {
                ...
                // Hent alle annonser tilknyttet gruppen
                ...
                if (membershipsError) {
                    console.error(
                        "Error fetching item memberships:",
                        membershipsError
                    );
                    setError(
                ...
                // Hent annonser tilknyttet gruppen
                const itemIds = memberships.map(
          ...
          `
                ...
                // Formater dataene slik at de passer til Item-typen
    ...
    /**
     * Navigerer tilbake til grupper-siden
     */
