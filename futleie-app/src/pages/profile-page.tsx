...
/**
 * En side som viser brukerens profil og deres annonser.
 *
 * Komponenten henter brukerens informasjon fra cookies og laster inn alle
 * annonser som brukeren har opprettet fra Supabase. Den presenterer brukerens
 * profilinformasjon i venstre del og deres annonser i høyre del av siden,
 * med mulighet for å opprette nye annonser.
 *
 * @returns En side med brukerens profil og annonser
 */
