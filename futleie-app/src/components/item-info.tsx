...
const ItemInfo: React.FC = () => {
  ...
  // Henter brukerinformasjon fra cookie
  useEffect(() => {
  ...
  // Henter informasjon om gjenstanden
  useEffect(() => {
  ...
  // Henter informasjon om eieren av gjenstanden
  useEffect(() => {
  ...
  /**
   * Henter datoer for allerede bookede perioder
   * @returns Dato for start og slutt på leieperioden
   */
  ...
  /**
   * Håndterer booking av gjenstanden
   * @returns
   */
  ...
  /**
   * Håndterer melding til eier av gjenstanden
   * @returns
   */
